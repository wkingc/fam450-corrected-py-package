...
def test_fam450ss_detailed_results():
    ...
    assert detailed_less == (
        "Null Hypothesis: The true tolerable rate of deviation is 5% or more.\n"
        "Alternative Hypothesis: The true tolerable rate of deviation is less "
        "than 5%.\n\n"
        "If the experimenter observes 4 deviations or less in a sample size "
        "of 158 (2.53%), they can reject with 90% confidence the null "
        "hypothesis that the true tolerable rate of deviation is 5% or more "
        "in favor of the alternative that it's less than 5%. If the "
        "experimenter observes more than 4 deviations, they fail to reject "
        "the null hypothesis, but cannot say the true tolerable rate of "
        "deviation is 5% or more.\n"
    )
    ...
    assert detailed_greater == (
        "Null Hypothesis: The true tolerable rate of deviation is at most 5%.\n"
        "Alternative Hypothesis: The true tolerable rate of deviation is "
        "greater than 5%.\n\n"
        "If the experimenter observes more than 11 deviations in a sample "
        "size of 158 (6.96%), they can reject with 90% confidence the null "
        "hypothesis that the true tolerable rate of deviation is at most 5% "
        "in favor of the alternative that it's greater than 5%. If the "
        "experimenter observes 11 or fewer deviations, they fail to reject "
        "the null hypothesis, but cannot say the true tolerable rate of "
...
def test_fam450ss_simple_results():
    ...
    assert simple_less == (
        "Four is the maximum number of allowed deviations that an experimenter has enough "
        "evidence to determine the internal controls are effective.\n"
    )
    ...
    assert simple_greater == (
        "Eleven is the minimum number of allowed deviations, after which an experimenter "
        "has enough evidence to determine the internal controls are ineffective.\n"
    )
